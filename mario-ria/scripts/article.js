...
// Because .sort is taking two arguments instead of just one like .forEach. If you have two or more and want to use the arrow function you must use the parens.
rawData.sort((a,b) => {
  return (new Date(b.publishedOn)) - (new Date(a.publishedOn));
});

// create instances of each rawData/article
